...
ALLOWED_DEVICE_TYPES: Final = SUPPORTED_DEVICE_TYPES | {
	"ELECTRIC_VEHICLES",
}

UNSUPPORTED_DEVICE_KEYWORDS: Final = (
	"METER",
	"REGISTRATION",
)

UNSUPPORTED_DEVICE_PROVIDERS: Final = (
	"OCTOPUS_ENERGY",
)

UNSUPPORTED_DEVICE_IDENTIFIERS: Final = (
	"OCTOPUS_ENERGY",
)
